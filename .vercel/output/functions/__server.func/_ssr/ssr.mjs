...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CZIoqKKy.mjs");
...
var manifest = {
	"18f7598532db70a6644a3dc21288d9434907426ff11382ebf91d88209d73d8da": {
		functionName: "generatePreviewReply_createServerFn_handler",
		importer: () => import("./preview-backend-DHmohtX8.mjs")
	},
	"24994bc2de141b34d3c3e1d36c6f6ad643f8778d06545c95a04fcd650d9e57a0": {
		functionName: "probePreviewBackend_createServerFn_handler",
		importer: () => import("./preview-backend-DHmohtX8.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DUpuW0Xe.mjs").then((n) => n.t),
